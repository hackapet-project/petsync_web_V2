...
export const animals: Animal[] = [
  { name: 'Luna', species: 'Perro', age: '2 Años', breed: 'Labrador', gender: 'Hembra', size: 'Grande', weight: '20.4kg', id: "129830JD", state: 'available', chip: 'X9783361'},
  { name: 'Max', species: 'Perro', age: '3 Años', breed: 'Pastor Alemán', gender: 'Macho', size: 'Grande', weight: '28.7kg', id: "092348C", state: 'adopted', chip: 'X9783362'},
  { name: 'Milo', species: 'Gato', age: '1 Año', breed: 'Europeo Común', gender: 'Macho', size: 'Mediano', weight: '4.1kg', id: "302418A", state: 'available', chip: 'X9783363'},
  { name: 'Nala', species: 'Gato', age: '4 Años', breed: 'Siamesa', gender: 'Hembra', size: 'Mediano', weight: '3.6kg', id:'4', state:'in_process', chip: 'X9783364'},
